...
const Project: React.FC<ProjectProps> = ({ title, description, pictures, logos, link }) => {
	return (
		<div className="p-2 my-8 mx-2 w-[380px] flex flex-col items-center bg-neutral-100 border-2 border-black rounded-xl">
			<h2 className="font-title text-2xl font-bold text-black">{title}</h2>
			<ImageSlider pictures={pictures} />
			<span className="m-2 text-black">{description}</span>
			<a className="button mx-16 my-4" href={link} target="_blank">
				View Live Project
			</a>
			<div>
				<span className="font-title font-bold text-black">Tech Stack</span>
